...
import 'package:attendance/view/all/WFH/history/wfh_details.dart';
...
import '../../nab_bar.dart';
import '../wfh_entry/wfh_entry.dart';
import 'cubit/wfh_history_state.dart';
import 'cubit/wfh_history_cubit.dart';


class WFHPage extends StatelessWidget {
  WFHPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: BlocProvider(
      create: (context) => WFHHistoryCubit()..loadData(),
      child: Scaffold(
            ...
            body: BlocConsumer<WFHHistoryCubit, WFHHistoryState>(
              ...
              return Center(
                        child: Column(
                          children: [
                                        ...
                                        child: RFDatePicker(
                                          ...
                                          onChange: (dateValue, jsonMapResult) {
                                            if(searchController.text.isNotEmpty){
                                              ...
                                              miscController.navigateTo(context: context,page: FilterPage(date: searchController.text,isLeave: false,));
                                            }
                                          },
                                                            ...
                                                            children: [
                                                              ...
                                                              CButton(buttonText: "Send", onTap: (){
                                                                if(year.isNotEmpty && month.isNotEmpty){
                                                                  ...
                                                                  miscController.navigateTo(context: context,page: FilterPage(month: month,year: year,isLeave: false,));
                                                                  year="";
                                                                  month="";
                            ...
                            state is WFHHistoryLoadedState?
                                    ...
                                    children: [
                                      ...
                                      Positioned(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              miscController.navigateTo(context: context,page: WFHDetailsPage(wfhDetails: state.listOfData[index]));
                                            },
                                            child: Container(
                          ...
                          SafeArea(
                            child: Padding(
                              ...
                              child: CButton(buttonText: "Make Approval", onTap: (){
                                miscController.navigateTo(context: context,page: WFHEntryPage());
                              },),
                            ),
                          ),
                        ],
