...
class SummaryCard extends StatelessWidget {
  ...
  final MonthAttendanceSummary attendanceHistory;
  SummaryCard({super.key,required this.attendanceHistory});
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 5,),
                RFText(text: "Early: ${attendanceHistory.lateHours??"Not Found"}",),
              ],
            ),
          ],
        ),
